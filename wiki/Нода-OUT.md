...
Принудительное прерывание "слушания" Алисы при любом входящем в ноду сообщении. Аналогично команде 16 из раздела [RAW-команды](RAW-команды).
...
Полный перечень команд — в разделе [RAW-команды](RAW-команды).
